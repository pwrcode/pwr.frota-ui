...
import { deleteMotivoParada, getMotivoParadas, type motivoParadaType, type postListagemMotivoParadaType } from '@/services/motivoParada';
            ...
            {(motivoParadas.length > 0) && (
                <div className="bg-card dark:bg-card py-1 rounded-md shadow-md dark:border">
                    ...
                    <TableRodape
                        ...
                        lengthCurrentPage={motivoParadas.length}
