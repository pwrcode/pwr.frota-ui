...
import { deleteVeiculoMarca, getVeiculoMarcas, type veiculoMarcaType, type postListagemVeiculoMarcaType } from '@/services/veiculoMarca';
            ...
            {(veiculoMarcas.length > 0) && (
                <div className="bg-card dark:bg-card py-1 rounded-md shadow-md dark:border">
                    ...
                    <TableRodape
                        ...
                        lengthCurrentPage={veiculoMarcas.length}
